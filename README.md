#interactive-days-in-power

Visualisation of PM's satisfaction ratings.
...
Quickly deploy and/or create new releases from the commandline. See the documentation for<br>[news-deploy-project-grunt](https://bitbucket.org/abcdevelop/news-deploy-project-grunt/) for<br>more details.
